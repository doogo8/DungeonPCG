...
namespace ProD
{
	public class Movement : MovingObject
	{

		public virtual void Setup(WorldMap newWorld)
		{
			//Override this in respective movement scripts.
		}

		public virtual void Setup(WorldMap newWorld, Address mapAdress, Address spawnPoint)
		{
			//Override this in respective movement scripts.
		}
	}
