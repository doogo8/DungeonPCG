...
namespace ProD
{
	public static class Generator_StickDungeon
	{
		...
		public static Map Generate()
		{
			...
			MethodLibrary.ExpandCell(new List<string> { "Wall" }, map, 0);
			...
			MethodLibrary.ConnectIsolatedAreas(map, type_Path, false, 1);
