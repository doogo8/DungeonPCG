...
namespace ProD
{
	public static class Generator_PerlinLikeBiome
	{
		...
		private static int conversion_Density = 5;
		private static int frame_Size = 1;
		private static int repeat_0 = 500;
		...
		public static Map Generate()
		{
			...
			MethodLibrary.FilterNoise(map, type_Path, conversion_Density, 0, repeat_1);
